...
class PackOptimizationServiceTest {
    ...
    @Test
    void testSubCategoryResponseList() {
        subCatgList = new HashSet<>();
    ...
    @Test
    void testGetMerchantPkOptConstraintDetails() {
