...
class CalculateFinelineBuyQuantityTest {
   ...
   ObjectMapper mapper = new ObjectMapper();
    ...
    void initialSetCalculationTest() throws SizeAndPackException, IOException {
       ...
       when(validationService.validateCalculateBuyQuantityInputData(any(APResponse.class), any(BQFPResponse.class), anyString(), any(CustomerChoiceDto.class))).thenReturn(ValidationResult.builder().codes(List.of(100,200)).build());
