...
public interface SizeLevelReplenishmentRepository extends JpaRepository<CcSpMmReplPack, CcSpMmReplPackId> {
	 @Query(value="select new com.walmart.aex.sp.dto.replenishment.ReplenishmentResponseDTO(msp.merchCatPlanId.planId, " +
	            ...
	            "fp.finelinePlanId.finelineNbr = :finelineNbr") 
	List<ReplenishmentResponseDTO> getReplnFullHierarchyByPlanFineline(@Param("planId") Long planId,
          		@Param("channelId") Integer channelId, @Param("finelineNbr") Integer finelineNbr);
