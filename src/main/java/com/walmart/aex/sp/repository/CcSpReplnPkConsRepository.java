...
public interface CcSpReplnPkConsRepository extends JpaRepository <CcSpMmReplPack, CcSpMmReplPackId>{
    ...
    @Query(value = "update rc_cc_sp_mm_replpk_fixtr_cons set vendor_pack_cnt = :vnpk,whse_pack_cnt= :whpk, vnpk_whpk_ratio= :vnpkWhpkRatio where plan_id = :plan_id and \n"
    ...
    void updateSizeData(@Param("plan_id") Long plan_id, @Param("channel_id") Integer channel_id,
            ...
            @Param("vnpkWhpkRatio") Double vnpkWhpkRatio, @Param("merchMethodDesc") String merchMethodDesc, @Param("fixtureTypeRollupId") Integer fixtureTypeRollupId);
}
