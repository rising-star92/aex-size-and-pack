...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "rc_cc_sp_mm_replpk_fixtr_cons", schema = "dbo")
@Embeddable
public class CcSpMmReplPack
{
    @EmbeddedId
    @EqualsAndHashCode.Include
    CcSpMmReplPackId ccSpReplPackId;
    ...
    @JoinColumn(name = "merch_method_code", referencedColumnName = "merch_method_code", nullable = false, insertable = false, updatable = false)
    ...
    @JsonIgnore
    private CcMmReplPack ccMmReplPack;
