...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "rc_subcatg_replpk_fixtr_cons", schema = "dbo")
@Embeddable
public class SubCatgReplPack
{
    @EmbeddedId
    @EqualsAndHashCode.Include
    SubCatgReplPackId subCatgReplPackId;
    ...
    @JsonIgnore
    private MerchCatgReplPack merchCatgReplPack;
    ...
    private Set<FinelineReplPack> finelineReplPack;
}
