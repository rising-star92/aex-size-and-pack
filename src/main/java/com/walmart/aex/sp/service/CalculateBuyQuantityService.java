...
public class CalculateBuyQuantityService {
    ...
    public CalculateBuyQuantityService(SpFineLineChannelFixtureRepository spFineLineChannelFixtureRepository, BQFPService bqfpService,
                                       SizeAndPackService sizeAndPackService, ObjectMapper objectMapper) {
    ...
    public void calculateFinelinesParallel(CalculateBuyQtyRequest calculateBuyQtyRequest, Lvl3Dto lvl3Dto, Lvl4Dto lvl4Dto) {
        ...
        List<CompletableFuture<List<SpFineLineChannelFixture>>> completableFutures = lvl4Dto.getFinelines().stream().map(finelineDto -> CompletableFuture.supplyAsync(() -> {
                    ...
                    try {
                        return calculateFinelineBuyQty(calculateBuyQtyRequest, lvl3Dto, lvl4Dto, finelineDto, spFineLineChannelFixtures2);
                    } catch (Exception e) {
        ...
        List<List<SpFineLineChannelFixture>> spFineLineChannelFixtures = completableFutures
                ...
                .collect(Collectors.toList());
        if (spFineLineChannelFixtures.size() == lvl4Dto.getFinelines().size()) {
    ...
    private List<SpFineLineChannelFixture> calculateFinelineBuyQty(CalculateBuyQtyRequest calculateBuyQtyRequest, Lvl3Dto lvl3Dto, Lvl4Dto lvl4Dto, FinelineDto fineline, List<SpFineLineChannelFixture> spFineLineChannelFixtures) throws SizeAndPackException {
    ...
    private APResponse getRfaSpResponse(CalculateBuyQtyRequest calculateBuyQtyRequest, FinelineDto fineline, BQFPResponse bqfpResponse) {
        ...
        apRequest.setVolumeDeviationLevel(bqfpResponse.getVolumeDeviationStrategyLevelSelection());
